...
namespace ConvenienceStore.ViewModel.SubViewModels
{
    public class AddEmployeeViewModel : BaseViewModel
    {
        ...
        public void Save(AddEmployeeView parameter)
        {
            ...
            {
                parameter.nameTxtbox.ErrorMessage.Text = "Please enter your full name!!";
                isValid = false;
            }
            else
            {
                ...
                {
                    parameter.nameTxtbox.ErrorMessage.Text = "Invalid name!!";
                    isValid = false;
                }
            }
            if (string.IsNullOrEmpty(parameter.emailTxtbox.textBox.Text))
            {
                parameter.emailTxtbox.ErrorMessage.Text = "Please enter email!!";
                isValid = false;
            }
            if (string.IsNullOrEmpty(parameter.phoneTxtbox.textBox.Text))
            {
                parameter.phoneTxtbox.ErrorMessage.Text = "Please enter phone number!!";
                isValid = false;
            }
            else
            {
                ...
                {
                    parameter.phoneTxtbox.ErrorMessage.Text = "Invalid phone number!!";
                    isValid = false;
                }
            }
            if (string.IsNullOrEmpty(parameter.addressTxtbox.textBox.Text))
            {
                parameter.addressTxtbox.ErrorMessage.Text = "Please enter Address!!";
                isValid = false;
            }
            if (string.IsNullOrEmpty(parameter.usernameTxtbox.textBox.Text))
            {
                parameter.usernameTxtbox.ErrorMessage.Text = "Please enter your username!!";
                isValid = false;
            }
            if (string.IsNullOrEmpty(parameter.passwordTxtbox.passwordBox.Password))
            {
                parameter.passwordTxtbox.ErrorMessage.Text = "Please enter password!!";
                isValid = false;
            }
            if (string.IsNullOrEmpty(parameter.confirmPasswordTxtbox.passwordBox.Password))
            {
                parameter.confirmPasswordTxtbox.ErrorMessage.Text = "Please confirm password!!";
                isValid = false;
            }
            else
            {
                ...
                {
                    parameter.confirmPasswordTxtbox.ErrorMessage.Text = "Confirmation password is incorrect, try again!!";
                    isValid = false;
                }
            }
            if (parameter.ManagerCombobox.SelectedValue == null)
            {
                parameter.ManagerErrorMessage.Text = "Please choose a manager!!";
                isValid = false;
            }
            if (parameter.ImageProduct.ImageSource == null)
            {
                parameter.ImageErrorMessage.Text = "Please select photo!!";
                isValid = false;
            }
            ...
            foreach (var account in accounts)
            {
                ...
                {
                    parameter.usernameTxtbox.ErrorMessage.Text = "Username already exists";
                    isValid = false;
                    break;
                }
                if (parameter.phoneTxtbox.textBox.Text == account.Phone)
                {
                    parameter.phoneTxtbox.ErrorMessage.Text = "Phone number has been registered";
                    isValid = false;
                    break;
                }
                if (parameter.emailTxtbox.textBox.Text == account.Email)
                {
                    parameter.emailTxtbox.ErrorMessage.Text = "The email was registered";
                    isValid = false;
                    break;
                }
