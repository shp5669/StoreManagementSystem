...
namespace ConvenienceStore.ViewModel.Login
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        public void Login(LoginWindow parameter)
        {
            ...
            {
                MessageBoxCustom mb = new("Warning!!", "Please enter your username", MessageType.Warning, MessageButtons.OK);
                mb.ShowDialog();
            ...
            {
                MessageBoxCustom mb = new("Warning!!", "Please enter your password", MessageType.Warning, MessageButtons.OK);
                mb.ShowDialog();
            ...
            foreach (var account in accounts)
            {
                ...
                if (account.UserName == UserName && account.Password == Password)
                {
                    ...
                    MessageBoxCustom mb = new("Notification", "Successful login", MessageType.Success, MessageButtons.OK);
                    flag = 1;
                    isLogin = true;
                    mb.ShowDialog();
            ...
            if (flag == 0)
            {
                MessageBoxCustom mb = new("Warning!!", "Incorrect username or password", MessageType.Warning, MessageButtons.OK);
                mb.ShowDialog();
                parameter.txtUsername.Focus();
                parameter.txtPassword.Focus();
            }
