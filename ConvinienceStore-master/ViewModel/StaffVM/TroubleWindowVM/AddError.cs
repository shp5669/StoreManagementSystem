...
namespace ConvenienceStore.ViewModel.TroubleWindowVM
{
    public partial class TroublePageViewModel : BaseViewModel
    {
        ...
        public void Save(AddTrouble p, Snackbar TroubleSnackbar)
        {
            ...
            {
                p.CostErrorMessage.Text = "Estimated costs have not been entered!!";
                isValid = false;
            }
            else
            {
                ...
                {
                    p.CostErrorMessage.Text = "Estimated costs are not valid!!";
                    isValid = false;
                }
            }
            ...
            {
                p.ImageProductErrorMessage.Text = "Photos have not been uploaded yet!!";
                isValid = false;
            }
            ...
            else
            {
                ...
                TroubleSnackbar.MessageQueue?.Enqueue($"Issue created \"{newReport.Title}\"", null, null, null, false, true, TimeSpan.FromSeconds(1));
                p.Close();
            }
        }
    }
