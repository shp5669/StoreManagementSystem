...
namespace ConvenienceStore.ViewModel.Admin.Command.InputInfoCommand
{
    public class CreateInputInfoButtonCommand : ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            if (supplier == null)
            {
                window.ComboBoxSupplierErrorMessage.Text = "Haven't selected a supplier yet!!";
                return;
            }
            ...
            VM.InputInfoSnackbar.MessageQueue?.Enqueue($"Created daily import on {newInputInfo.InputDate.ToString("dd/MM/yyyy")}", null, null, null, false, true, TimeSpan.FromSeconds(0.9));
