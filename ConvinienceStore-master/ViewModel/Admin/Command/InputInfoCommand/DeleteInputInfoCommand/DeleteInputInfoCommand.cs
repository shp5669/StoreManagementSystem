...
namespace ConvenienceStore.ViewModel.Admin.Command.InputInfoCommand.DeleteInputInfoCommand
{
    public class DeleteInputInfoCommand : ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            VM.InputInfoSnackbar.MessageQueue?.Enqueue($"Deleted daily import on {inputInfo.InputDate.ToString("dd/MM/yyyy")}", null, null, null, false, true, TimeSpan.FromSeconds(0.7));
